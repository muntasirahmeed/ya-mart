import {faBars, faBell, faPrint, faSearch, faSignOut, faUser} from "@fortawesome/free-solid-svg-icons";
	...
	return (
		...
		>
			...
			<div className="flex items-center gap-10 text-gray-500">
				...
				<div onClick={() => setShowProfile(!showProfile)} className="flex items-center gap-3 relative cursor-pointer">
